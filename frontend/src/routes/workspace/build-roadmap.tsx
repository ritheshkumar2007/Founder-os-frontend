        ...
        right={
          <div className="flex flex-wrap items-center gap-2 sm:gap-3">
            ...
            >
              ...
              <span>{generating ? "Designing..." : "Generate Technical Roadmap"}</span>
            </button>
          </div>
        }
      />
            ...
            <div className="space-y-4">
              {roadmapData.developmentPhases?.map((p, i) => (
                <div key={i} className="rounded-xl border border-white/5 bg-[#101417] p-5 space-y-3">
                  ...
                  <p className="text-xs text-[#cbc3d7] font-sans">{p.objectives}</p>
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 pt-2">
                    ...
                    <div>
                      <span className="text-[11px] font-mono font-semibold text-white">Deliverables:</span>
