...
export const SprintMissionAnalysisModal: React.FC<SprintMissionAnalysisModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#020408]/85 backdrop-blur-xl animate-fade-in select-none">
      <div className="w-full max-w-2xl rounded-2xl border border-white/10 bg-[#0b0f12] text-[#e0e3e7] shadow-[0_25px_60px_rgba(0,0,0,0.8),0_0_35px_rgba(139,92,246,0.2)] overflow-hidden flex flex-col max-h-[90vh]">
        {/* Modal Header */}
        ...
        <div className="p-6 space-y-5 overflow-y-auto flex-1">
          {/* Progress / Status */}
          <div className="p-4 rounded-xl bg-[#101417] border border-white/10 space-y-3">
            ...
            {/* Progress Bar */}
            <div className="w-full bg-[#1c2023] h-2 rounded-full overflow-hidden border border-white/10">
              <div
                className="bg-zinc-800 h-full transition-all duration-300 shadow-[0_0_12px_#d4d4d8]"
          ...
          <div className="rounded-xl border border-white/10 bg-[#020408] p-4 font-mono text-xs text-[#cbc3d7] space-y-1.5 h-36 overflow-y-auto shadow-inner">
            <div className="text-zinc-300 font-bold mb-2 flex items-center gap-2 border-b border-white/5 pb-1">
          ...
          {completed && (
            <div className="space-y-4 animate-fade-in">
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-xs font-mono">
                <div className="p-3.5 rounded-xl border border-white/10 bg-[#101417]">
                  ...
                  <span className="text-[11px] text-zinc-300 block mt-0.5">Top 10% pacing</span>
                </div>
                <div className="p-3.5 rounded-xl border border-white/10 bg-[#101417]">
                  ...
                  <span className="text-[11px] text-zinc-300 block mt-0.5">Core targets locked</span>
                </div>
                <div className="p-3.5 rounded-xl border border-white/10 bg-[#101417]">
              ...
              <div className="p-4 rounded-xl border border-white/10 bg-[#101417] space-y-2.5 text-xs">
                <span className="font-mono text-[10px] uppercase text-zinc-300 font-bold block">
        ...
        <div className="px-6 py-4 border-t border-white/10 bg-[#101417] flex justify-between items-center text-xs font-mono">
          ...
          <button
            onClick={onClose}
            className="btn-system text-white font-bold px-5 py-2.5 rounded-lg transition-all shadow-[0_4px_20px_rgba(0,0,0,0.5)] cursor-pointer"
          >
