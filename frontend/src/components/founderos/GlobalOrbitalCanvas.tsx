...
export const GlobalOrbitalCanvas: React.FC = () => {
  return (
    <section className="relative py-20 px-4 max-w-7xl mx-auto z-10">
      <div className="panel p-8 sm:p-12 border border-white/10 bg-[#0b0f12] backdrop-blur-2xl relative overflow-hidden shadow-[0_25px_60px_rgba(0,0,0,0.8)] rounded-3xl">
        {/* Soft Ambient Glow */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-zinc-800/60 rounded-full blur-3xl pointer-events-none" />

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative z-10">
          {/* Left Information */}
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/10 bg-[#101417] text-xs font-mono text-zinc-300 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4 pt-2 font-mono text-xs">
              <div className="p-4 rounded-2xl border border-white/5 bg-[#101417] space-y-1">
                ...
                <p className="text-lg font-bold text-zinc-300">12ms Avg</p>
              </div>
              <div className="p-4 rounded-2xl border border-white/5 bg-[#101417] space-y-1">
          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-4">
            {HUBS.map((h) => (
              <div
                key={h.city}
                className="p-4 rounded-2xl border border-white/5 bg-[#101417] transition-all duration-200 hover:border-white/10 hover:bg-[#181c1f] space-y-3"
              >
                ...
                <div className="flex items-center justify-between text-xs font-mono text-[#cbc3d7] pt-1">
                  ...
                  <span className="text-zinc-300">{h.latency}</span>
                </div>
              </div>
            ))}
          </div>
