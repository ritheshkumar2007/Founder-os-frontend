    ...
    >
      ...
      <div
        className={`max-w-[85%] sm:max-w-[75%] rounded-2xl p-4 sm:p-5 text-sm transition-all shadow-md ${
          isAssistant
            ? "rounded-tl-sm border border-white/10 bg-[#101417]/90 backdrop-blur-xl text-white shadow-[0_10px_25px_rgba(0,0,0,0.5)]"
            : "rounded-tr-sm bg-zinc-800 text-white border border-white/10 font-medium shadow-[0_4px_20px_rgba(139,92,246,0.35)]"
        }`}
      >
        {/* Role header for assistant */}
        {isAssistant && (
          <div className="flex items-center gap-1.5 text-[11px] font-mono text-zinc-300 mb-2 font-medium">
      ...
      {/* Founder Avatar */}
      {!isAssistant && (
        <div className="shrink-0 size-9 rounded-xl bg-[#101417] border border-white/10 text-white flex items-center justify-center shadow-md mt-0.5">
